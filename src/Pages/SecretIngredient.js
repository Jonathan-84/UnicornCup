...
class SecretIngredient extends Component {
    ...
    render() {
        ...
        return (
          ...
          <p className='explText'><span className='events'>Events Origins and Rules: </span> Much as many would refer to Jeopardy as a "Couple's Rite of Passage",
          ...
          Ingredient. Over the years, Llamaphones has had an unprecented run. Naturally it would become an event for this prestigous Cup. Broken into 3 rounds, 
      ...
      the contestants have lives (at this point you may be debating that), they decided to call it a draw. The closest either contestant came was when they guessed the Secret Ingredient
