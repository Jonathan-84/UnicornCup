...
class Jeopardy extends Component {
    ...
    render() {
        ...
        <p className='explText'><span className='events'>Events Origins and Rules: </span> Inspired by the "couple's rite of passage", 
        that most couple's have done at some point in their relationship, the contestants sat down and played along with Jeopardy. 
        ...
        you only got one attempt, the first to answer got the point(s)- 1 point in first round and 2 points in second round, and there was not 
